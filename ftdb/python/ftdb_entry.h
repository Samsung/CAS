...
#define PYLIST_ADD_ULONG(__list, __node)                   \
    do {                                                   \
...
#define PYLIST_ADD_LONG(__list, __node)            \
    do {                                           \
...
#define PYLIST_ADD_STRING(__list, __node)             \
    do {                                              \
...
#define PYLIST_ADD_FLOAT(__list, __node)              \
    do {                                              \
...
#define PYLIST_ADD_PYOBJECT(__list, __node) \
    do {                                    \
        PyList_Append(__list, __node);      \
        Py_DECREF(__node);                  \
    } while (0)

#define PYSET_ADD_PYOBJECT(__set, __node)     \
    do {                                      \
...
#define PYTUPLE_SET_ULONG(__tuple, __index, __node)        \
    do {                                                   \
        PyObject *__val = PyLong_FromUnsignedLong(__node); \
        PyTuple_SetItem(__tuple, __index, __val);          \
    } while (0)

#define PYTUPLE_SET_LONG(__tuple, __index, __node) \
    do {                                           \
        PyObject *__val = PyLong_FromLong(__node); \
        PyTuple_SetItem(__tuple, __index, __val);  \
    } while (0)

#define PYTUPLE_SET_STR(__tuple, __index, __node)       \
    do {                                                \
        PyObject *__val = PyUnicode_FromString(__node); \
        PyTuple_SetItem(__tuple, __index, __val);       \
    } while (0)

#define PYTUPLE_SET_PYOBJECT(__tuple, __index, __node) \
    do {                                               \
        PyTuple_SetItem(__tuple, __index, __node);     \
    } while (0)

#define PYASSTR_DECREF(__node)                                                                 \
    do {                                                                                       \
