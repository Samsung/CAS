...
static void libftdb_ftdb_funcdecls_dealloc(libftdb_ftdb_funcdecls_object *self) {
    Py_DecRef((PyObject *)self->py_ftdb);
    PyTypeObject *tp = Py_TYPE(self);
    tp->tp_free(self);
}

static PyObject *libftdb_ftdb_funcdecls_new(PyTypeObject *subtype, PyObject *args, PyObject *kwds) {
...
static PyObject *libftdb_ftdb_funcdecls_repr(PyObject *self) {
...
static Py_ssize_t libftdb_ftdb_funcdecls_sq_length(PyObject *self) {
    libftdb_ftdb_funcdecls_object *__self = (libftdb_ftdb_funcdecls_object *)self;
...
static PyObject *libftdb_ftdb_funcdecls_entry_by_id(libftdb_ftdb_funcdecls_object *self, PyObject *args) {
    unsigned long id;
...
static PyObject *libftdb_ftdb_funcdecls_contains_id(libftdb_ftdb_funcdecls_object *self, PyObject *args) {
    unsigned long id;
    if (!PyArg_ParseTuple(args, "k", &id))
        return NULL;
...
static PyObject *libftdb_ftdb_funcdecls_entry_by_hash(libftdb_ftdb_funcdecls_object *self, PyObject *args) {
    const char *hash;
...
static PyObject *libftdb_ftdb_funcdecls_contains_hash(libftdb_ftdb_funcdecls_object *self, PyObject *args) {
    const char *hash;
    if (!PyArg_ParseTuple(args, "s", &hash))
        return NULL;
...
static PyObject *libftdb_ftdb_funcdecls_entry_by_name(libftdb_ftdb_funcdecls_object *self, PyObject *args) {
    const char *name;
...
static PyObject *libftdb_ftdb_funcdecls_contains_name(libftdb_ftdb_funcdecls_object *self, PyObject *args) {
    const char *name;
    if (!PyArg_ParseTuple(args, "s", &name))
        return NULL;
