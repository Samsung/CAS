...
static void libftdb_ftdb_funcs_iter_dealloc(libftdb_ftdb_funcs_iter_object *self) {
    Py_DecRef((PyObject *)self->funcs);
    PyTypeObject *tp = Py_TYPE(self);
    tp->tp_free(self);
}

static PyObject *libftdb_ftdb_funcs_iter_new(PyTypeObject *subtype, PyObject *args, PyObject *kwds) {
...
static Py_ssize_t libftdb_ftdb_funcs_iter_sq_length(PyObject *self) {
    libftdb_ftdb_funcs_iter_object *__self = (libftdb_ftdb_funcs_iter_object *)self;
    return __self->funcs->ftdb->funcs_count;
}

static PyObject *libftdb_ftdb_funcs_iter_next(PyObject *self) {
    libftdb_ftdb_funcs_iter_object *__self = (libftdb_ftdb_funcs_iter_object *)self;
...
PySequenceMethods libftdb_ftdbFuncsIter_sequence_methods = {
    .sq_length = libftdb_ftdb_funcs_iter_sq_length,
};

PyTypeObject libftdb_ftdbFuncsIterType = {
