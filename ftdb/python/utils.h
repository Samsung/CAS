...
#define TIME_CHECK_ON(start_marker, end_marker)                                                                                                                                                                                                                            \
    do {                                                                                                                                                                                                                                                                   \
        struct timeval tv_mark_##start_marker##_##end_marker;                                                                                                                                                                                                              \
        gettimeofday(&tv_mark_##start_marker##_##end_marker, 0);                                                                                                                                                                                                           \
        printf("@Elapsed (" #start_marker " -> " #end_marker "): (%f)[s]\n", (double)(tv_mark_##start_marker##_##end_marker.tv_usec - tv_mark_##start_marker.tv_usec) / 1000000 + (double)(tv_mark_##start_marker##_##end_marker.tv_sec - tv_mark_##start_marker.tv_sec)); \
    } while (0)
#define TIME_CHECK_FMT(start_marker, end_marker, fmt)                                                                                                                                                             \
    do {                                                                                                                                                                                                          \
        struct timeval tv_mark_##start_marker##_##end_marker;                                                                                                                                                     \
        gettimeofday(&tv_mark_##start_marker##_##end_marker, 0);                                                                                                                                                  \
        printf(fmt, (double)(tv_mark_##start_marker##_##end_marker.tv_usec - tv_mark_##start_marker.tv_usec) / 1000000 + (double)(tv_mark_##start_marker##_##end_marker.tv_sec - tv_mark_##start_marker.tv_sec)); \
    } while (0)
...
#define ASSERT_WITH_FTDB_FORMAT_ERROR(__expr, __msg, ...)             \
    do {                                                              \
        if (!(__expr)) {                                              \
...
#define ASSERT_RETURN_WITH_FTDB_FORMAT_ERROR(__expr, __msg, __retcode, ...) \
    do {                                                                    \
        if (!(__expr)) {                                                    \
            snprintf(errmsg, ERRMSG_BUFFER_SIZE, __msg, __VA_ARGS__);       \
            PyErr_SetString(libftdb_ftdbError, errmsg);                     \
...
#define CHECK_ASSIGN_FILE_FILTER_FUNC_WITH_FTDB_FORMAT_ERROR(__fltkey, ...)                                           \
    do {                                                                                                              \
...
#define CHECK_ASSIGN_COMMAND_FILTER_FUNC_WITH_FTDB_FORMAT_ERROR(__fltkey, ...)                                       \
    do {                                                                                                             \
